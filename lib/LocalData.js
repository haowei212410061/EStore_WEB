...
export const AboutUsContent = `We are an online shopping platform dedicated to providing diverse
        fashion choices. Select high-quality products from around the world to
        meet the unique style of each customer`;

export const ContactUs = `leave a message through our contact form and we will get back to you as soon as possible.
Thank you for your support!`;

export const BrandContent = `we actively promote sustainable development, select environmentally friendly materials, and reduce excessive packaging, so that every shopping experience is more meaningful and we can do our part for the earth.`;
